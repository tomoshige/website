# Python でのデータサイエンス入門 {#getting-started}
...
## Python と Google Colab とは？ {#python-colab}
...
### Python と Google Colab の準備 {#setup}
...
### 基本的なプログラミング概念と用語 {#programming-concepts}
...
## 最初のデータセットを探索する {#explore-datasets}
